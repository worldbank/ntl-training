...
output:
  html_document:
    ...
    theme: cosmo
description: Provides an introduction to spatial analysis in R and for working with BlackMarble nighttime lights data.
---

```{r setup, include=FALSE}
# library(learnr)  # Commented out for static rendering
library(tidyverse)
library(sf)
library(terra)
library(geodata)
...
# tutorial_options(  # Commented out for static rendering
