---
title: "Nighttime Lights for Economic Analysis"
---
...
1. **Introduction to Spatial Analysis** [[HTML](trainings/01_spatial_analysis_review.html)]: Overview of working with vector and raster spatial data in R.
2. **Nighttime Lights for Economic Analysis** [[PDF](trainings/02_into_nighttime_lights.pdf)]: Overview of nighttime light datasets and use of nighttime lights for economic and social science analysis.
3. **Nighttime Lights Analysis in R** [[HTML](trainings/03_intro_blackmarbler.html)]: Provides of overview of querying and analyzing nighttime lights data in R.
...
For more information, see [Country Diagnostics](ntl-diagnostic-code/ntl-diagnostics.html).
